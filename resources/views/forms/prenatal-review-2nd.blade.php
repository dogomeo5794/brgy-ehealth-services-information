	...
	<tbody>
		...
		<tr>
			<td>
				...
				<b>{{ $data->data['etiologic_test_if_needed'] }}</b>
			</td>
		</tr>
		<tr>
			<td>
				Pap Smear, kung kinakailangan: 
				<b>{{ $data->data['pap_smear_if_needed'] }}</b>
			</td>
		</tr>
		<tr>
			<td>
				Gestational diabetes (oral glucose challenge test), kung kinakailangan: 
				<b>{{ $data->data['gestational_diabetes_if_needed'] }}</b>
			</td>
		</tr>
		<tr>
			<td>
				Bacteriurial, kung kinakailangan: 
				<b>{{ $data->data['bacteriuria_if_needed'] }}</b>
			</td>
		</tr>
		<tr>
			<td>
				...
				<ul class="list-unstyled">
					<li>
						<i class="far {{ $data->data['treatments']=='Deworming' ? 'fa-check-square' : 'fa-square' }}"></i> Deworming
					</li>
					<li>
		...
		<tr>
			<td>
				...
				<ul class="list-unstyled">
					<li>
						{!! $data->data['discussion_services_given']['reminder_previous_discussion']=='true'?'<i class="far fa-check-square"></i>':'-' !!}
